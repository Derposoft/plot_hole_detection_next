...
class FileHandler(object):
    ...
    def init_log_files(cls, log_file):
        if log_file != None:
            ...
            cls.error_analysis_log_validation = open(
                log_file + "_error_analysis_validation.json", "w"
            )
            cls.error_analysis_log_testing = open(
                log_file + "_error_analysis_testing.json", "w"
            )
            cls.error_analysis_log_test2 = open(
                log_file + "_error_analysis_test2.json", "w"
            )
            cls.error_analysis_log_test3 = open(
    ...
    def save_error_analysis_validation(cls, message: str):
        assert (
            cls.error_analysis_log_validation != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
    ...
    def save_error_analysis_testing(cls, message: str):
        assert (
            cls.error_analysis_log_testing != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
    ...
    def save_error_analysis_test2(cls, message: str):
        assert (
            cls.error_analysis_log_test2 != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
    ...
    def save_error_analysis_test3(cls, message: str):
        assert (
            cls.error_analysis_log_test3 != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
