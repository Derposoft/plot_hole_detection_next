...
class FileHandlerFC(object):
    ...
    def init_log_files(self, log_file):
        if log_file != None:
            ...
            self.error_analysis_log_validation = open(
                log_file + "_error_analysis_validation.json", "w"
            )
            self.error_analysis_log_testing = open(
                log_file + "_error_analysis_testing.json", "w"
            )
            self.error_analysis_log_test2 = open(
                log_file + "_error_analysis_test2.json", "w"
            )
            self.error_analysis_log_test3 = open(
                log_file + "_error_analysis_test3.json", "w"
            )
    ...
    def myprint_details(self, message):
        assert (
            self.mylogfile_details != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
    ...
    def save_error_analysis_validation(self, message: str):
        assert (
            self.error_analysis_log_validation != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
    ...
    def save_error_analysis_testing(self, message: str):
        assert (
            self.error_analysis_log_testing != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
    ...
    def save_error_analysis_test2(self, message: str):
        assert (
            self.error_analysis_log_test2 != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
    ...
    def save_error_analysis_test3(self, message: str):
        assert (
            self.error_analysis_log_test3 != None
        ), "The Detailed JSON log file is not initialized yet!"
        # print(message)
