...
class Embedding(object):
    ...
    def build_matrix(
        self,
        term_index: typing.Union[dict, mz.preprocessors.units.Vocabulary.TermIndex],
        ...
        for term, index in sorted(
            term_index.items(), key=lambda x: x[1]
