...
class BasePreprocessor(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def fit(self, data_pack: "mz.DataPack", verbose: int = 1) -> "BasePreprocessor":
        """
    ...
    @abc.abstractmethod
    def transform(self, data_pack: "mz.DataPack", verbose: int = 1) -> "mz.DataPack":
        """
    ...
    def fit_transform(
        self, data_pack: "mz.DataPack", verbose: int = 1
    ) -> "mz.DataPack":
        """
        Call fit-transform.
        ...
        :param verbose: Verbosity.
        """
        return self.fit(data_pack, verbose=verbose).transform(
    ...
    def save(self, dirpath: typing.Union[str, Path]):
        ...
        if data_file_path.exists():
            raise FileExistsError(
                "{data_file_path} instance exist, fail to save.".format(
