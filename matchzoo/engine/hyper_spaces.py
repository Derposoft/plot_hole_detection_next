...
class HyperoptProxy(object):
    ...
    def __init__(
        self, hyperopt_func: typing.Callable[..., hyperopt.pyll.Apply], **kwargs
    ):
        """
...
class quniform(HyperoptProxy):
    ...
    def __init__(
        self, low: numbers.Number, high: numbers.Number, q: numbers.Number = 1
    ):
        """
        :func:`hyperopt.hp.quniform` proxy.
        ...
        """
        super().__init__(hyperopt_func=hyperopt.hp.quniform, low=low, high=high, q=q)
        self._low = low
        self._high = high
        self._q = q
    ...
    def __str__(self):
        """:return: `str` representation of the hyper space."""
        return (
            "quantitative uniform distribution in  "
...
class uniform(HyperoptProxy):
    ...
    def __init__(self, low: numbers.Number, high: numbers.Number):
        """
        :func:`hyperopt.hp.uniform` proxy.
