...
class CommonTestCases:
    ...
    class GPTModelTester(CommonModelTester):
        ...
        def prepare_config_and_inputs(self):
            ...
            if self.use_labels:
                ...
                mc_token_ids = ids_tensor(
                    [self.batch_size, self.n_choices], self.seq_length
                )
        ...
        def create_and_check_double_heads(
            ...
            self.parent.assertListEqual(
                list(mc_logits.size()), [self.batch_size, self.n_choices]
            )
        ...
        def create_and_check_model_from_pretrained(self):
            ...
            for model_name in list(
                self.base_model_class.pretrained_model_archive_map.keys()
            )[:1]:
...
class ConfigTester(object):
    ...
    def create_and_test_config_to_json_file(self):
        ...
        json_file_path = os.path.join(
            os.getcwd(), "config_" + str(uuid.uuid4()) + ".json"
        )
