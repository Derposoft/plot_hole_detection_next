...
from pytorch_transformers.tokenization_roberta import (
    RobertaTokenizer,
    VOCAB_FILES_NAMES,
)
...
class RobertaTokenizationTest(CommonTestCases.CommonTokenizerTester):
    ...
    def roberta_dict_integration_testing(self):
        ...
        self.assertListEqual(tokenizer.encode("Hello world!"), [0, 31414, 232, 328, 2])
        self.assertListEqual(
    ...
    def test_sequence_builders(self):
        ...
        encoded_text_from_decode = tokenizer.encode(
            "sequence builders", add_special_tokens=True
        )
