...
class GPT2ModelTest(CommonTestCases.CommonModelTester):
    ...
    class GPT2ModelTester(object):
        ...
        def create_and_check_lm_head_model(
            ...
            loss, lm_logits, _ = model(
                input_ids, token_type_ids=token_type_ids, labels=input_ids
            )
        ...
        def create_and_check_double_lm_head_model(
            ...
            loss, lm_logits, mc_logits, _ = model(
                input_ids, token_type_ids=token_type_ids, lm_labels=input_ids
            )
